...
def define_table(columns, typeTable):
    ...
    attrs2 = dict((c, tables.TemplateColumn('<a href="{{record.Link_to_results}}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Go to results</a>')) for c in columns if c == "Link to results")
