...
from crispy_forms.layout import Layout, Fieldset, ButtonHolder, Submit, Field, Div, Row, Button
...
class miRNAgFreeForm(forms.Form):
    ADAPTERS = (
    ...
    def __init__(self, *args, **kwargs):
        super(miRNAgFreeForm, self).__init__(*args, **kwargs)
        ...
        self.helper.layout = Layout(
            ...
            ButtonHolder(
                Button('Button 1', 'Test', css_class='btn btn-success')
            ),
    ...
    def clean(self):
        cleaned_data = super(miRNAgFreeForm, self).clean()
