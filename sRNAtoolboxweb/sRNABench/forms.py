...
class sRNABenchForm(forms.Form):
    ...
    def create_conf_file(self, cleaned_data, pipeline_id):
        ...
        is_solid = 'true' if 'is_solid' in cleaned_data else 'false'
        guess_adapter = 'true' if 'guess_adapter' in cleaned_data else 'false'
        predict_mirna = 'true' if 'predict_mirna' in cleaned_data else 'false'
        no_libs = 'true' if 'no_libs' in cleaned_data else 'false'
        highconf = 'true' if 'highconf' in cleaned_data else 'false'
        recursive_adapter_trimming = 'true' if 'adapter_recursive_trimming' in cleaned_data else 'false'
