...
parser.add_argument('microRNA_file')
parser.add_argument('target_file')
parser.add_argument('output_directory')
parser.add_argument('threads')
parser.add_argument('program_string', help='PSROBOT:TAPIR_FASTA:TAPIR_HYBRID')
parser.add_argument('program_parameters', nargs='?', default='')
